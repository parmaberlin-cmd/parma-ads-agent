...
test('compatibility summary remains non-activating',()=>{assert.deepEqual(metaCompatibilitySummary(),{api_version:'v26.0',paused_only:true,targeting_automation_explicit:true,advantage_audience:0,timezone_schedule_conversion:true,known_error_addressed:1870227});});
