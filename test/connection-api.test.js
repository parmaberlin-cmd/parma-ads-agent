...
test('resolver grants verified Google and Railway read capabilities', () => {
...
test('resolver fails closed for missing input and unavailable Wix capability', () => {
  ...
  assert.equal(wix.health, 'unavailable');
});
