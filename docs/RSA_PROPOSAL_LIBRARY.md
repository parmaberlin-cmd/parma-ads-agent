...
## Family B — Quality / product
Headlines:
- Bio Pizza in Kreuzberg
- Pizza mit Sauerteig
- Italienische Zutaten
- Handwerkliche Pizza in Berlin
- Bio Restaurant in Kreuzberg
- Parma Bio Pizza Berlin
...
## Evaluation contract
Evaluate structural completeness, relevance to query family, policy compliance and landing-path consistency first. Do not use current unverified conversion counts to declare a winning RSA. Any future publication requires an independent write gate and a reversible mutation package.
