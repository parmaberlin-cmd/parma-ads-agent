...
const SAFE_AUTONOMOUS_ACTIONS = new Set([
  'collect_metrics','refresh_shadow_snapshot','run_diagnostics','generate_report','record_internal_journal','score_recommendation','simulate_budget','runtime.self_test',
