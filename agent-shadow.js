...
function buildShadowAgentReport(input = {}) {
  ...
  const keywordInventory=google.keywords || input.live_sources?.google?.keywords || [];
  const searchRecommendations=analyzeSearchTerms(liveSearchTerms,{knownKeywords:keywordInventory});
